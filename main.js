...
async function AskQuestion() {
    const answers = await inquirer.prompt([
        ...
        },
        {
            ...
            message: (chalk.bold.bgBlueBright("Which of the following filenames is the extension for typescript ?")),
        },
        {
            type: "list",
            name: "Question4",
            choices: ["readonly", "static", "!", "?"],
            message: (chalk.bold.bgBlueBright("Which TypeScript feature allows defining optional properties in interfaces?")),
        },
    ]);
    const marks = 10;
    const fail = 0;
